...
function getUrlAndOpen (d, cb) {
  var r = d.repository
  if (!r) return cb(new Error('no repositories'))
  ...
  if (!url) return cb(new Error('no repositories: could not get url'))

  openUrl(url, 'repositories available at the following URL', cb)
}
