...
class UserService {
    ...
    approveUser(id) {
        return this.dataService.post(`/api/users/approve/com.loanlead:loanlead-web:jar:1.0-SNAPSHOT`, null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((data) => data.data));
    }
    getLoggedUsers() {
